## Windows Pilet 2 kontrollskript ##
...
.SYNOPSIS
    ...
    Sisaldab detailset osalist hindamist ja unikaalseid failinimesid/päringuid andmebaasi.
...
# Salvestame unikaalse nimega HTML-i
...
Write-Host "HTML raport salvestatud: $ReportPath" -ForegroundColor Cyan
...
# Salvestame unikaalse nimega JSON faili lokaalselt
$JsonString | Out-File $JsonPath -Encoding UTF8
Write-Host "JSON andmestik salvestatud: $JsonPath" -ForegroundColor Cyan
