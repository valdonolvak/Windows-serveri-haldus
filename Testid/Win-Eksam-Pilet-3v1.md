...
.SYNOPSIS
    ...
    Sisaldab nutikat Folder Redirection (Pilvekaustad) hindamist, fuzzy otsingut ja IP-põhist failoveri kontrolli.
...
$dc2Status = [bool]($DC2)
$dc2LeitudText = if($DC2){"Leitud DC2 konto AD-st"}else{"Ei leitud arvutit DC2"}
Add-Result "WinCore2025 masinal muuta nimi DC2-ks" "AD-s eksisteerib arvuti DC2" $dc2LeitudText $dc2Status 0.5

# DC2 IP Tuvastus (Nutikas ja lollikindel)
