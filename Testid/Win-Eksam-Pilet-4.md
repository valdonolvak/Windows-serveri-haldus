...
$resTurv = Check-GPOSettings "TurvalineSisselogimine" @() @("(?i)DontDisplayLastUserName", "(?i)Guest|SeDenyInteractiveLogonRight|SeInteractiveLogonRight|Local account") 1.0
...
# 18. KeelaUSB
$resUsb = Check-GPOSettings "KeelaUSB" @("Arvutid") @("(?i)RemovableDisksDenyRead|Deny_Read", "(?i)RemovableDisksDenyWrite|Deny_Write") 1.0
...
# 21. ParooliKehtivus (Kontrollib nii GPO_ParooliKehtivus kui ka Default Domain Policy)
